...
// Alerte envoyée J-7 : 4 août 2026 à 20h00 Paris (CEST = UTC+2)
export const METEORITE_WARNING_DATE = new Date("2026-08-04T18:00:00Z");
// Crash à 8h00 Paris le 11 août — zone accessible dès cet instant
const EVENT_START = new Date("2026-08-11T06:00:00Z");
export const EVENT_END = new Date("2026-08-11T21:59:59Z"); // 23h59:59 Paris
...
export const METEORITE_RAID_SLOTS: MeteoriteRaidSlot[] = [
  {
    openTime: new Date("2026-08-11T08:00:00Z"),
    closeTime: new Date("2026-08-11T10:00:00Z"),
    deoxysPokemonId: 386,
    label: "Deoxys (Forme Normale)",
  },
  {
    openTime: new Date("2026-08-11T11:30:00Z"),
    closeTime: new Date("2026-08-11T13:30:00Z"),
    deoxysPokemonId: 4103,
    label: "Deoxys (Forme Attaque)",
  },
  {
    openTime: new Date("2026-08-11T16:00:00Z"),
    closeTime: new Date("2026-08-11T18:00:00Z"),
    deoxysPokemonId: 4104,
    label: "Deoxys (Forme Défense)",
  },
  {
    openTime: new Date("2026-08-11T19:00:00Z"),
    closeTime: new Date("2026-08-11T21:00:00Z"),
