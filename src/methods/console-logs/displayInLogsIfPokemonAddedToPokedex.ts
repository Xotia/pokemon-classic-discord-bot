...
export function displayInLogsIfPokemonAddedToPokedex(guildId: string, interaction: any, isAdded: boolean, random: { id: number; name: string; rarity: string; image: string; shinyImage: string; }) {
    ...
    getLoggerForGuild(guildId).info(message);
}